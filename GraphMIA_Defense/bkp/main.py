...
if args.dataset == 'usair':
    ...
    # CKA tab
    # param = {'plain_acc': 0.4703, 'aug_pe': 0.36, 'layer-0': 4.1, 'layer-1': 0, 'layer-2': 4.8, 'layer_inter-0': 3.2, 'layer_inter-1': 0.7}
    # Acc: 0.431; AUC: 0.77
...
ACC, AUC, victim_model, IAZ, IYZ, full_losses = objective(param) # 
...
# path = os.path.join('visual/with_MI', args.dataset)
